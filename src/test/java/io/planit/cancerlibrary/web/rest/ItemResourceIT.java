...
class ItemResourceIT {
    ...
    void partialUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.activated(UPDATED_ACTIVATED);
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).activated(UPDATED_ACTIVATED);
