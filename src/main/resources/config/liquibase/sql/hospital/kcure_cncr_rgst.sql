...
insert into ph_item_property (item_id, caption, required, allow_editing) values (1002,'초진연월일', false, true);
...
insert into ph_item_property (item_id, caption, required, allow_editing) values (1029,'사망연월일', false, true);
...
insert into ph_item_property (item_id, caption, required, allow_editing) values (1040,'입원일', false, true);
insert into ph_item (id, title, description, activated, category_id, created_by) values (1041, 'disdate', '', true, 1001, 'system');
insert into ph_item_property (item_id, caption, required, allow_editing) values (1041,'퇴원일', false, true);
...
insert into ph_item_property (item_id, caption, required, allow_editing) values (1043,'입력일', false, true);
...
insert into ph_item_property (item_id, caption, required, allow_editing) values (1053,'생성일시,', true, true);
