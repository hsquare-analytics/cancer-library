...
CREATE TABLE IF NOT EXISTS GSTR.GSTR_PT_FMHT_UPDATED (
                              hosp_cd varchar(20) NOT NULL, 							-- 병원코드
                              pt_no varchar(10) NOT NULL, 							-- 환자대체번호
                              fmht_rcrd_ymd varchar(8) NOT NULL, 						-- 가족력기록일자
                              fmht_rcrd_seq numeric(3) NOT NULL, 						-- 가족력기록순번
...
insert into ph_item_property (item_id, caption, required) values (9203, '가족력기록일자', true);
...
insert into ph_item_property (item_id, caption, required) values (9226, '생성일시', true);
