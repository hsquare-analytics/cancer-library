...
VALUES (19000, 'bltr_prsc_ymd', '19.위암_치료_수혈');
...
insert into ph_item (id, title, category_id, created_by, order_no) values (19012, 'sort_seq', 19000, 'system', 5);
insert into ph_item_attribute (item_id, caption) values (19012, '정렬순번');
