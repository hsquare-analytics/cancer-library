...
VALUES (16000, 'esd_srpr_ymd', '16.위암_치료_시술');
...
insert into ph_item_attribute (item_id, caption, required, format, data_type) values (16005, 'ESD시술시작일시', true, 'HH:mm:ss', 'time');

insert into ph_item (id, title, category_id, created_by, order_no) values (16006, 'esd_srpr_end_dt', 16000, 'system', 16006);
insert into ph_item_attribute (item_id, caption, required, format, data_type) values (16006, 'ESD시술종료일시', true, 'HH:mm:ss', 'time');
...
insert into ph_item (id, title, category_id, created_by, order_no) values (16024, 'sort_seq', 16000, 'system', 5);
insert into ph_item_attribute (item_id, caption) values (16024, '정렬순번');
