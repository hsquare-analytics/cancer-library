...
insert into ph_item (id, title, category_id, created_by, order_no) values (16024, 'sort_seq', 16000, 'system', 16024);
insert into ph_item_attribute (item_id, caption) values (16024, '정렬순서');
