...
VALUES (9200, 'fmht_rcrd_ymd', '02.위암_환자_가족력');
...
insert into ph_item_attribute (item_id, caption, data_type) values (9205, '가족력여부무응답구분코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9205, 'fmht_yn_noans_spnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9206, 'fmht_yn_noans_spnm', 9200, 'system', 9206);
-- insert into ph_item_attribute (item_id, caption) values (9206, '가족력여부무응답구분명');

insert into ph_item (id, title, category_id, created_by, order_no, codebook_id) values (9207, 'pt_fm_rlcd', 9200, 'system', 9207, 10070);
insert into ph_item_attribute (item_id, caption, data_type) values (9207, '환자가족관계코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9207, 'pt_fm_rlnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9208, 'pt_fm_rlnm', 9200, 'system', 9208);
-- insert into ph_item_attribute (item_id, caption) values (9208, '환자가족관계명');

insert into ph_item (id, title, category_id, created_by, order_no) values (9209, 'pt_fmrl_etc_cont', 9200, 'system', 9209);
insert into ph_item_attribute (item_id, caption) values (9209, '환자가족관계기타내용');
...
insert into ph_item_attribute (item_id, caption, data_type) values (9210, '가족병력고혈압여부무응답구분코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9210, 'fmhs_htn_yn_noans_spnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9211, 'fmhs_htn_yn_noans_spnm', 9200, 'system', 9211);
-- insert into ph_item_attribute (item_id, caption) values (9211, '가족병력고혈압여부무응답구분명');
...
insert into ph_item_attribute (item_id, caption, data_type) values (9212, '가족병력당뇨여부무응답구분코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9212, 'fmhs_dbt_yn_noans_spnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9213, 'fmhs_dbt_yn_noans_spnm', 9200, 'system', 9213);
-- insert into ph_item_attribute (item_id, caption) values (9213, '가족병력당뇨여부무응답구분명');
...
insert into ph_item_attribute (item_id, caption, data_type) values (9214, '가족력결핵여부무응답구분코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9214, 'fmht_tb_yn_noans_spnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9215, 'fmht_tb_yn_noans_spnm', 9200, 'system', 9215);
-- insert into ph_item_attribute (item_id, caption) values (9215, '가족력결핵여부무응답구분명');
...
insert into ph_item_attribute (item_id, caption, data_type) values (9216, '가족병력간질환여부무응답구분코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9216, 'fmhs_lvds_yn_noans_spnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9217, 'fmhs_lvds_yn_noans_spnm', 9200, 'system', 9217);
-- insert into ph_item_attribute (item_id, caption) values (9217, '가족병력간질환여부무응답구분명');
...
insert into ph_item_attribute (item_id, caption, data_type) values (9218, '가족병력암여부무응답구분코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9218, 'fmhs_cncr_yn_noans_spnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9219, 'fmhs_cncr_yn_noans_spnm', 9200, 'system', 9219);
-- insert into ph_item_attribute (item_id, caption) values (9219, '가족병력암여부무응답구분명');
...
insert into ph_item_attribute (item_id, caption, data_type) values (9220, '가족력암종류코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9220, 'fmht_cncr_knnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9221, 'fmht_cncr_knnm', 9200, 'system', 9221);
-- insert into ph_item_attribute (item_id, caption) values (9221, '가족력암종류명');

insert into ph_item (id, title, category_id, created_by, order_no) values (9222, 'fmht_cncr_kind_etc_cont', 9200, 'system', 9222);
insert into ph_item_attribute (item_id, caption) values (9222, '가족력암종류기타내용');
...
insert into ph_item_attribute (item_id, caption, data_type) values (9223, '가족병력기타여부무응답구분코드', 'selectbox');
insert into ph_item_property (item_id, label_column) values (9223, 'fmhs_etc_yn_noans_spnm');

-- insert into ph_item (id, title, category_id, created_by, order_no) values (9224, 'fmhs_etc_yn_noans_spnm', 9200, 'system', 9224);
-- insert into ph_item_attribute (item_id, caption) values (9224, '가족병력기타여부무응답구분명');
