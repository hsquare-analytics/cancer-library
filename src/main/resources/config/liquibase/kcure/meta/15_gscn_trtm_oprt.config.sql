...
insert into ph_item_property (item_id, label_column) values (15005, '05 수술종류코드');
...
insert into ph_item_property (item_id, label_column) values (15016, '수술목적코드');
...
insert into ph_item_property (item_id, label_column) values (15018, '수술방법코드');
...
insert into ph_item_property (item_id, label_column) values (15020, '수술마취부위코드');
...
insert into ph_item_property (item_id, label_column) values (15022, 'ASA점수코드');
...
insert into ph_item_property (item_id, label_column) values (15024, '수술절개방법코드');
...
insert into ph_item_property (item_id, label_column) values (15026, '수술둘레방향종양위치코드');
...
insert into ph_item_property (item_id, label_column) values (15028, '수술종방향1종양위치코드');
...
insert into ph_item_property (item_id, label_column) values (15030, '수술종방향2종양위치코드');
...
insert into ph_item_property (item_id, label_column) values (15032, '진단복강경검사여부확인불가구분코드');
...
insert into ph_item_property (item_id, label_column) values (15034, '수술장내시경사용여부확인불가구분코드');
...
insert into ph_item_property (item_id, label_column) values (15036, '형광영상사용여부확인불가구분코드');
...
insert into ph_item_property (item_id, label_column) values (15038, '수술시항암요법코드');
...
insert into ph_item_property (item_id, label_column) values (15040, '유착방지제사용여부확인불가구분코드');
...
insert into ph_item_property (item_id, label_column) values (15043, '그물막절제범위코드');
...
insert into ph_item_property (item_id, label_column) values (15045, '근치도코드');
...
insert into ph_item_property (item_id, label_column) values (15047, '림프절절제정도코드');
...
insert into ph_item_property (item_id, label_column) values (15050, '합병절제부위코드');
...
insert into ph_item_property (item_id, label_column) values (15052, '재건술종류코드');
...
insert into ph_item_property (item_id, label_column) values (15055, '재건술방법코드');
...
insert into ph_item_property (item_id, label_column) values (15057, '재건술접근법코드');
...
insert into ph_item_property (item_id, label_column) values (15060, '복수여부확인불가구분코드');
