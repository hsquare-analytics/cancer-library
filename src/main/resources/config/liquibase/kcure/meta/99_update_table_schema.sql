...
ALTER TABLE gstr.cncr_rgst_updated
...
ALTER TABLE gstr.gstr_pt_hlinf_updated
    ADD COLUMN CREATED_BY CHARACTER VARYING(50),
    ADD COLUMN CREATED_DATE TIMESTAMP,
    ADD COLUMN LAST_MODIFIED_BY CHARACTER VARYING(50),
    ADD COLUMN LAST_MODIFIED_DATE TIMESTAMP;
...
ALTER TABLE gstr.gstr_pt_fmht_updated
    ADD COLUMN CREATED_BY CHARACTER VARYING(50),
    ADD COLUMN CREATED_DATE TIMESTAMP,
    ADD COLUMN LAST_MODIFIED_BY CHARACTER VARYING(50),
    ADD COLUMN LAST_MODIFIED_DATE TIMESTAMP;
...
ALTER TABLE gstr.gstr_diag_aninf_updated
    ADD COLUMN CREATED_BY CHARACTER VARYING(50),
    ADD COLUMN CREATED_DATE TIMESTAMP,
    ADD COLUMN LAST_MODIFIED_BY CHARACTER VARYING(50),
    ADD COLUMN LAST_MODIFIED_DATE TIMESTAMP;
...
ALTER TABLE gstr.gstr_diag_inf_updated
    ADD COLUMN CREATED_BY CHARACTER VARYING(50),
    ADD COLUMN CREATED_DATE TIMESTAMP,
    ADD COLUMN LAST_MODIFIED_BY CHARACTER VARYING(50),
    ADD COLUMN LAST_MODIFIED_DATE TIMESTAMP;
...
ALTER TABLE gstr.gstr_diag_stag_updated
    ADD COLUMN CREATED_BY CHARACTER VARYING(50),
    ADD COLUMN CREATED_DATE TIMESTAMP,
    ADD COLUMN LAST_MODIFIED_BY CHARACTER VARYING(50),
    ADD COLUMN LAST_MODIFIED_DATE TIMESTAMP;
