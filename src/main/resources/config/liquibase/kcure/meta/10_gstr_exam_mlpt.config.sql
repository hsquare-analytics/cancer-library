...
insert into ph_item_property (item_id, caption, required) values (10001, '병원코드', true);

insert into ph_item (id, title, category_id, created_by, order_no) values (10002, 'pt_no', 10000, 'system', 10002);
insert into ph_item_property (item_id, caption, visible) values (10002, '환자대체번호', false);

insert into ph_item (id, title, category_id, created_by, order_no) values (10003, 'mlem_ymd', 10000, 'system', 10003);
insert into ph_item_property (item_id, caption, required, format) values (10003, '분자병리검사일자', true, 'yyyy-MM-dd');
insert into ph_item_attribute (item_id, data_type) values (10003, 'date');

insert into ph_item (id, title, category_id, created_by, order_no) values (10004, 'mlem_seq', 10000, 'system', 10004);
insert into ph_item_property (item_id, caption, required) values (10004, '분자병리검사순번', true);

insert into ph_item (id, title, category_id, created_by, order_no) values (10005, 'mlpt_read_ymd', 10000, 'system', 10005);
insert into ph_item_property (item_id, caption, format) values (10005, '분자병리판독일자', 'yyyy-MM-dd');
insert into ph_item_attribute (item_id, data_type) values (10005, 'date');

insert into ph_item (id, title, category_id, created_by, order_no) values (10006, 'mlem_cd', 10000, 'system', 10006);
insert into ph_item_property (item_id, caption) values (10006, '분자병리검사코드');

insert into ph_item (id, title, category_id, created_by, order_no) values (10007, 'mlem_nm', 10000, 'system', 10007);
insert into ph_item_property (item_id, caption) values (10007, '분자병리검사명');

insert into ph_item (id, title, category_id, created_by, order_no, codebook_id) values (10008, 'mlem_kncd', 10000, 'system', 10008, 30230);
insert into ph_item_property (item_id, caption) values (10008, '분자병리검사종류코드(30230)');
insert into ph_item_attribute (item_id, data_type) values (10008, 'selectbox');

insert into ph_item (id, title, category_id, created_by, order_no) values (10009, 'mlem_knnm', 10000, 'system', 10009);
insert into ph_item_property (item_id, caption) values (10009, '분자병리검사종류명');
