...
VALUES (9900, 'GSTR.GSTR_EXAM_IMPT', '09.위암_검사_면역병리', true, 6, 999, 'system');
...
insert into ph_item_property (item_id, caption, required) values (9901, '병원코드', true);
...
insert into ph_item_property (item_id, caption) values (9913, '면역병리검사결과단위코드');
insert into ph_item_attribute (item_id, data_type) values (9913, 'selectbox');
...
insert into ph_item_property (item_id, caption) values (9918, 'UI용 PACT_ID');
