...
insert into ph_item_property (item_id, caption) values (9011, '행려환자');
...
insert into ph_item_property (item_id, caption) values (9015, '직업분류기타');
...
insert into ph_item_property (item_id, caption) values (9019, '진단경로5세부설명');

insert into ph_item (id, title, category_id, created_by, order_no) values (9020, 'tcode', 9000, 'system', 9020);
insert into ph_item_property (item_id, caption) values (9020, '원발부위코드');

insert into ph_item (id, title, category_id, created_by, order_no) values (9021, 'tcode1', 9000, 'system', 9021);
insert into ph_item_property (item_id, caption) values (9021, '원발부위코드설명');
...
insert into ph_item_property (item_id, caption) values (9025, '조직학적진단명코드');

insert into ph_item (id, title, category_id, created_by, order_no) values (9026, 'mcode1', 9000, 'system', 9026);
insert into ph_item_property (item_id, caption) values (9026, '조직학적진단명코드설명');
...
insert into ph_item_property (item_id, caption, format) values (9030, '사망연월일', 'yyyy-MM-dd');
insert into ph_item_attribute (item_id, data_type) values (9030, 'date');
...
insert into ph_item_property (item_id, caption) values (9034, '진단방법 임상검사2세부사항');
...
insert into ph_item_property (item_id, caption, format) values (9042, '퇴원일', 'yyyy-MM-dd');
insert into ph_item_attribute (item_id, data_type) values (9042, 'date');

insert into ph_item (id, title, category_id, created_by, order_no) values (9043, 'dbyear', 9000, 'system', 9043);
insert into ph_item_property (item_id, caption) values (9043, '자료등록년도');

insert into ph_item (id, title, category_id, created_by, order_no) values (9044, 'inputday', 9000, 'system', 9044);
insert into ph_item_property (item_id, caption, format) values (9044, '입력일', 'yyyy-MM-dd');
insert into ph_item_attribute (item_id, data_type) values (9044, 'date');
