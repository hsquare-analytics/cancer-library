...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        io.planit.cancerlibrary.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        io.planit.cancerlibrary.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleAbnormalSetupException(
        io.planit.cancerlibrary.service.AbnormalSetupException ex,
        NativeWebRequest request
    ) {
        AbnormalSetupException problem = new AbnormalSetupException();
        return create(
            problem,
            request,
            HeaderUtil.createFailureAlert(applicationName, true, problem.getEntityName(), problem.getErrorKey(),
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleBadSqlGrammerException(BadSqlGrammarException ex, NativeWebRequest request) {
        return create(
            Status.BAD_REQUEST,
            ex,
            request,
            HeaderUtil.createFailureAlert(applicationName, true, "sql", "sqlSyntax", ex.getMessage())
        );
    }
