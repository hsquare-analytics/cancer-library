...
export const RegisterPage = props => {
  ...
  return (
    <Modal
      ...
      toggle={() => setShowRegisterModal(false)}
      id="register-page"
      autoFocus={false}
    ...
    >
      <Row className="justify-content-center">
        <Col>
          <ModalHeader id="register-title" data-cy="registerTitle" toggle={() => setShowRegisterModal(false)}>
      ...
      <Row className="justify-content-center">
        <Col>
          <ValidatedForm id="register-form" onSubmit={handleValidSubmit}>
            ...
            <ModalFooter className="no-border-top center">
