...
export const LibraryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="cancerLibraryApp.library.delete.question">
        <Translate contentKey="cancerLibraryApp.library.delete.question" interpolate={{ id: libraryEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ph-confirm-delete-library" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
