...
export const UserPatientDetail = () => {
  ...
  return (
    <div className="wrap-page">
      <Row>
        <Col md="8">
          <h2 data-cy="pointDetailsHeading" className="title-page">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              {userPatientEntity.createdDate ? (
                <TextFormat value={userPatientEntity.createdDate} type="date" format={APP_DATE_FORMAT} blankOnInvalid />
              ) : null}
            </dd>
            <dt>
